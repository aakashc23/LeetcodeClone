        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-20">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                {[
                  {
                    ...
                    href: "https://github.com/aakashc23",
                  ...
                  },
                  {
                    ...
                    href: "https://www.linkedin.com/in/aakashchaurasia23ac/",
            ...
            <div>
              ...
              <ul className="space-y-4">
                {[
                  { icon: <Mail className="h-5 w-5" />, text: "aakash.csedtu@gmail.com" },
                  { icon: <Phone className="h-5 w-5" />, text: "+91 7065508775" },
                  { icon: <MapPin className="h-5 w-5" />, text: "New Delhi, India" },
                ].map((contact, index) => (
